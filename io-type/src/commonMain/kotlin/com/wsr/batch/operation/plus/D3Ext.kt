...
operator fun Batch<IOType.D3>.plus(other: IOType.D2) = map { it.plus2(other, axis1 = 1, axis2 = 2) }

@JvmName("batchD3sPlusD2s")
operator fun Batch<IOType.D3>.plus(other: Batch<IOType.D2>) = plus2(other, axis1 = 1, axis2 = 2)

@JvmName("batchD3sPlusD2sWithAxis")
fun Batch<IOType.D3>.plus2(other: Batch<IOType.D2>, axis1: Int, axis2: Int) =
    Batch(size) { this[it].plus2(other = other[it], axis1 = axis1, axis2 = axis2) }
