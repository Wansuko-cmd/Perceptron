package com.wsr.core.elementwise.operation.times
...
operator fun IOType.D4.times(other: IOType.D0): IOType.D4 {
    val result = Backend.times(x = value, y = other.get())
    return IOType.D4(shape = shape, value = result)
}

fun IOType.D4.times(other: IOType.D1, axis: Int): IOType.D4 {
...
fun IOType.D4.times(other: IOType.D2, axis1: Int, axis2: Int): IOType.D4 {
    val result = Backend.times(
        x = value,
        xi = i,
        xj = j,
...
fun IOType.D4.times(other: IOType.D3, axis1: Int, axis2: Int, axis3: Int): IOType.D4 {
    val result = Backend.times(
        x = value,
        xi = i,
        xj = j,
