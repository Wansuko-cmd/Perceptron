...
operator fun IOType.D3.plus(other: IOType.D2): IOType.D3 = this.plus(other = other, axis = 0)

fun IOType.D3.plus(other: IOType.D2, axis: Int): IOType.D3 = when (axis) {
    ...
    else -> throw IllegalArgumentException("IOType.D3.plus axis is $axis not 0, 1 or 2.")
}
...
fun IOType.D3.plus2(other: IOType.D2, axis1: Int, axis2: Int) = zipWith(other, axis1, axis2) { a, b -> a + b }
