...
fun IOType.D2.div2(other: IOType.D1, axis: Int): IOType.D2 = zipWith(other, axis) { a, b -> a / b }

operator fun IOType.D2.div(other: IOType.D2): IOType.D2 = IOType.d2(this.shape) { i, j -> this[i, j] / other[i, j] }

operator fun IOType.D2.div(other: IOType.D3): IOType.D3 = this.div(other = other, axis = 0)

fun IOType.D2.div(other: IOType.D3, axis: Int): IOType.D3 = when (axis) {
    ...
    else -> throw IllegalArgumentException("IOType.D2.div axis is $axis not 0, 1 or 2.")
}

fun IOType.D2.div2(other: IOType.D3, axis1: Int, axis2: Int) = zipWith(other, axis1, axis2) { a, b -> a / b }
