...
@ScopeOp
operator fun Batch<IOType.D1>.div(other: Float): Batch<IOType.D1.Global> {
...
@ScopeOp
operator fun Batch<IOType.D1>.div(other: Batch<IOType.D0>): Batch<IOType.D1.Global> {
...
@ScopeOp
operator fun Batch<IOType.D1>.div(other: IOType.D1): Batch<IOType.D1.Global> {
...
@ScopeOp
operator fun Batch<IOType.D1>.div(other: Batch<IOType.D1>): Batch<IOType.D1.Global> {
...
@ScopeOp
fun Batch<IOType.D1>.div(other: Batch<IOType.D2>, axis: Int): Batch<IOType.D2.Global> {
    val result = Backend.div(
        x = value,
        xi = size,
        xj = i,
