...
@ScopeOp
operator fun Batch<IOType.D0>.div(other: Float): Batch<IOType.D0.Global> {
...
@ScopeOp
operator fun Batch<IOType.D0>.div(other: Batch<IOType.D0>): Batch<IOType.D0.Global> {
...
@ScopeOp
operator fun Batch<IOType.D0>.div(other: Batch<IOType.D1>): Batch<IOType.D1.Global> {
...
@ScopeOp
operator fun Batch<IOType.D0>.div(other: Batch<IOType.D2>): Batch<IOType.D2.Global> {
...
@ScopeOp
operator fun Batch<IOType.D0>.div(other: Batch<IOType.D3>): Batch<IOType.D3.Global> {
    val result = Backend.div(
        x = value,
        y = other.value,
        yi = size,
