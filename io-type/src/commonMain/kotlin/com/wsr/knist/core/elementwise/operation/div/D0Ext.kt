...
operator fun Float.div(other: IOType.D0): IOType.D0 = IOType.d0(this / other.unwrap())
...
operator fun IOType.D0.div(other: Float): IOType.D0 = IOType.d0(unwrap() / other)

operator fun IOType.D0.div(other: IOType.D0): IOType.D0 = IOType.d0(unwrap() / other.unwrap())

operator fun IOType.D0.div(other: IOType.D1): IOType.D1 {
    val result = Backend.div(x = unwrap(), y = other.value)
    return IOType.D1(value = result)
}
