...
@ScopeOp
fun IOType.D1.exp(): IOType.D1.Global {
    val result = Backend.exp(x = value)
    return IOType.D1(value = result)
}

@ScopeOp
fun IOType.D1.ln(e: Float): IOType.D1.Global {
    val result = Backend.ln(x = value, e = e)
    return IOType.D1(value = result)
}

@ScopeOp
fun IOType.D1.pow(n: Int): IOType.D1.Global {
    val result = Backend.pow(x = value, n = n)
    return IOType.D1(value = result)
}

@ScopeOp
fun IOType.D1.softmax(): IOType.D1.Global {
    val max = max()
