...
@ScopeOp
fun IOType.D3.where(condition: IOType.D3, onTrue: IOType.D3 = this, onFalse: Float): IOType.D3.Global {
    val result = Backend.where(condition.value, onTrue.value, onFalse)
    return IOType.D3(shape = shape, value = result)
}
...
@ScopeOp
fun IOType.D3.where(condition: IOType.D3, onTrue: IOType.D3 = this, onFalse: IOType.D3 = this): IOType.D3.Global {
    val result = Backend.where(condition.value, onTrue.value, onFalse.value)
    return IOType.D3(shape = shape, value = result)
}
