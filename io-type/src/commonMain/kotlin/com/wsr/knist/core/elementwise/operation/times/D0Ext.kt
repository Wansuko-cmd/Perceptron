...
operator fun Float.times(other: IOType.D0): IOType.D0 = IOType.D0(Backend.times(x = this, y = other.value))
...
operator fun IOType.D0.times(other: Float): IOType.D0 = IOType.D0(Backend.times(x = value, y = other))

operator fun IOType.D0.times(other: IOType.D0): IOType.D0 = IOType.D0(Backend.times(x = value, y = other.value))
