...
class DivTest {
    ...
    fun `1次元÷スカラー`() = ioTypeTestRule {
        val d1 = IOType.d1(listOf(2f, 4f, 6f, 8f))
        val actual = d1 / 2f
        assertContentEquals(
    ...
    fun `1次元÷1次元`() = ioTypeTestRule {
        val d1a = IOType.d1(listOf(2f, 6f, 12f, 20f))
    ...
    fun `2次元÷スカラー`() = ioTypeTestRule {
        val d2 = IOType.d2(2, 2) { i, j -> (i * 2f + j + 1f) * 2f }
        val actual = d2 / 2f
        assertContentEquals(
    ...
    fun `2次元÷2次元`() = ioTypeTestRule {
        val d2a = IOType.d2(2, 2) { i, j -> (i * 2f + j + 1f) * 2f }
    ...
    fun `2次元_axis=0÷1次元`() = ioTypeTestRule {
        val d2 = IOType.d2(3, 4) { i, j -> (i * 4f + j) * (i + 1f) }
        val d1 = IOType.d1(listOf(1f, 2f, 3f))
        val actual = d2.div(d1, axis = 0)
        assertContentEquals(
            expected = IOType.d2(3, 4) { i, j -> i * 4f + j },
            actual = actual,
        )
    }
    ...
    fun `2次元_axis=1÷1次元`() = ioTypeTestRule {
        val d2 = IOType.d2(3, 4) { i, j -> (i * 4f + j) * (j + 1f) }
        val d1 = IOType.d1(listOf(1f, 2f, 3f, 4f))
        val actual = d2.div(d1, axis = 1)
        assertContentEquals(
            expected = IOType.d2(3, 4) { i, j -> i * 4f + j },
            actual = actual,
        )
