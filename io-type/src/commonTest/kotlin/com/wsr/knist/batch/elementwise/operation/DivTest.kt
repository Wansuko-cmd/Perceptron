...
class DivTest {
    ...
    fun `D0バッチ÷スカラー`() = ioTypeTestRule {
        val batch = Batch.of(IOType.d0(10f), IOType.d0(20f), IOType.d0(30f))
    ...
    fun `スカラー÷D0バッチ`() = ioTypeTestRule {
        val batch = Batch.of(IOType.d0(2f), IOType.d0(4f), IOType.d0(5f))
    ...
    fun `D0バッチ÷D0バッチ`() = ioTypeTestRule {
        val batch1 = Batch.of(IOType.d0(10f), IOType.d0(20f))
        val batch2 = Batch.of(IOType.d0(2f), IOType.d0(4f))
