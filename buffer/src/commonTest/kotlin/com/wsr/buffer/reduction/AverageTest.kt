...
package com.wsr.buffer.reduction
...
class AverageTest {
    ...
    fun `2次元平均_axis=0`() = bufferTestRule {
        ...
        assertContentEquals(expected = DataBuffer.create(9f, 10f, 11f, 12f, 13f, 14f), actual = actual)
    }
    ...
    fun `2次元平均_axis=1`() = bufferTestRule {
        ...
        assertContentEquals(expected = DataBuffer.create(2.5f, 8.5f, 14.5f, 20.5f), actual = actual)
    }
    ...
    fun `3次元平均_axis=1`() = bufferTestRule {
        ...
        assertContentEquals(expected = DataBuffer.create(2f, 3f, 8f, 9f, 14f, 15f, 20f, 21f), actual = actual)
    }
