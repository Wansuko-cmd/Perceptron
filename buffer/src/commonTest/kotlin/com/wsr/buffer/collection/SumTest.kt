...
class SumTest {
    ...
    @Test
    fun `2次元累積値(axis=0)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `2次元累積値(axis=1)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `3次元累積値(axis=0)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `3次元累積値(axis=1)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `3次元累積値(axis=2)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `4次元累積値(axis=0)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `4次元累積値(axis=1)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `4次元累積値(axis=2)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
    ...
    @Test
    fun `4次元累積値(axis=3)`() = bufferTestRule {
        val x = DataBuffer.create(FloatArray(24) { it.toFloat() })
