package com.wsr.cpu.reduction;

import java.nio.ByteBuffer;

public class JCollection {
    public native float averageD1(ByteBuffer x);
    public native void averageD2(ByteBuffer x, int xi, int xj, int axis, ByteBuffer result);
    public native void averageD3(ByteBuffer x, int xi, int xj, int xk, int axis, ByteBuffer result);
    public native void averageD4(ByteBuffer x, int xi, int xj, int xk, int xl, int axis, ByteBuffer result);

    public native float maxD1(ByteBuffer x);
    ...
    public native float minD1(ByteBuffer x);
    ...
    public native float sumD1(ByteBuffer x);
