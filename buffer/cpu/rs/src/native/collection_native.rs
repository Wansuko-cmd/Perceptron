...
#[unsafe(no_mangle)]
pub extern "C" fn com_wsr_cpu_average_d4(x: *const f32, xi: i32, xj: i32, xk: i32, xl: i32, axis: i32, result: *mut f32) {
...
#[unsafe(no_mangle)]
pub extern "C" fn com_wsr_cpu_max_d4(x: *const f32, xi: i32, xj: i32, xk: i32, xl: i32, axis: i32, result: *mut f32) {
    let x_size = xi * xj * xk * xl;
    let x = unsafe { std::slice::from_raw_parts(x, x_size as usize) };
...
#[unsafe(no_mangle)]
pub extern "C" fn com_wsr_cpu_min_d4(x: *const f32, xi: i32, xj: i32, xk: i32, xl: i32, axis: i32, result: *mut f32) {
    let x_size = xi * xj * xk * xl;
    let x = unsafe { std::slice::from_raw_parts(x, x_size as usize) };
...
#[unsafe(no_mangle)]
pub extern "C" fn com_wsr_cpu_sum_d4(x: *const f32, xi: i32, xj: i32, xk: i32, xl: i32, axis: i32, result: *mut f32) {
    let x_size = xi * xj * xk * xl;
    let x = unsafe { std::slice::from_raw_parts(x, x_size as usize) };
