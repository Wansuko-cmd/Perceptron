...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_cpu_JMatMul_inner(
    env: JNIEnv,
    _class: JClass,
    x: JByteBuffer,
    y: JByteBuffer,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_cpu_JMatMul_matMulD1ToD2(
    env: JNIEnv,
    _class: JClass,
    x: JByteBuffer,
    y: JByteBuffer,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_cpu_JMatMul_matMulD2ToD1(
    env: JNIEnv,
    _class: JClass,
    x: JByteBuffer,
    trans_x: jboolean,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_cpu_JMatMul_matMulD2ToD2(
    env: JNIEnv,
    _class: JClass,
    x: JByteBuffer,
    trans_x: jboolean,
