...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_elementwise_math_JMath_exp(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    result: jlong,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_elementwise_math_JMath_ln(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    e: jfloat,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_elementwise_math_JMath_sigmoid(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    result: jlong,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_elementwise_math_JMath_pow(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    n: jint,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_elementwise_math_JMath_sqrt(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    e: jfloat,
