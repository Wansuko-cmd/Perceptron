...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_index_JIndex_gather(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    y: jlong,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_wsr_knist_gpu_index_JIndex_scatterAdd(
    _: JNIEnv,
    _class: JClass,
    x: jlong,
    y: jlong,
    ...
    ops::index::scatter_add(x, y, i as usize, j as usize, k as usize, b as usize, result, runtime);
}
