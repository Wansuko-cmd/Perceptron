...
import com.wsr.network.converter.char.CharD1
import com.wsr.network.converter.char.CharsD1
import com.wsr.network.converter.linear.LinearD1
import com.wsr.network.converter.linear.LinearD2
import com.wsr.network.converter.linear.LinearD3
import com.wsr.network.converter.word.WordD1
...
import com.wsr.network.optimizer.adam.AdamD1
import com.wsr.network.optimizer.adam.AdamD2
import com.wsr.network.optimizer.adam.AdamD3
import com.wsr.network.optimizer.adam.AdamD4
import com.wsr.network.optimizer.adam.AdamWD1
import com.wsr.network.optimizer.adam.AdamWD2
import com.wsr.network.optimizer.adam.AdamWD3
import com.wsr.network.optimizer.adam.AdamWD4
import com.wsr.network.optimizer.momentum.MomentumD1
import com.wsr.network.optimizer.momentum.MomentumD2
import com.wsr.network.optimizer.momentum.MomentumD3
import com.wsr.network.optimizer.momentum.MomentumD4
import com.wsr.network.optimizer.rms.RmsPropD1
import com.wsr.network.optimizer.rms.RmsPropD2
import com.wsr.network.optimizer.rms.RmsPropD3
import com.wsr.network.optimizer.rms.RmsPropD4
import com.wsr.network.optimizer.sgd.SgdD1
import com.wsr.network.optimizer.sgd.SgdD2
import com.wsr.network.optimizer.sgd.SgdD3
import com.wsr.network.optimizer.sgd.SgdD4
import com.wsr.network.output.Output
import com.wsr.network.output.mean.MeanSquareD1
import com.wsr.network.output.mean.MeanSquareD2
import com.wsr.network.output.sigmoid.SigmoidWithLossD1
import com.wsr.network.output.sigmoid.SigmoidWithLossD2
import com.wsr.network.output.softmax.SoftmaxWithLossD1
import com.wsr.network.output.softmax.SoftmaxWithLossD2
import com.wsr.network.process.Process
import com.wsr.network.process.compute.affine.AffineD1
import com.wsr.network.process.compute.affine.AffineD2
import com.wsr.network.process.compute.attention.AttentionD2
import com.wsr.network.process.compute.bias.d1.BiasD1
import com.wsr.network.process.compute.bias.d2.BiasAxisD2
...
import com.wsr.network.process.compute.dropout.DropoutD1
import com.wsr.network.process.compute.dropout.DropoutD2
import com.wsr.network.process.compute.dropout.DropoutD3
import com.wsr.network.process.compute.function.relu.LeakyReLUD1
import com.wsr.network.process.compute.function.relu.LeakyReLUD2
import com.wsr.network.process.compute.function.relu.LeakyReLUD3
import com.wsr.network.process.compute.function.relu.ReLUD1
import com.wsr.network.process.compute.function.relu.ReLUD2
import com.wsr.network.process.compute.function.relu.ReLUD3
import com.wsr.network.process.compute.function.relu.SwishD1
import com.wsr.network.process.compute.function.relu.SwishD2
import com.wsr.network.process.compute.function.relu.SwishD3
import com.wsr.network.process.compute.function.sigmoid.SigmoidD1
import com.wsr.network.process.compute.function.sigmoid.SigmoidD2
import com.wsr.network.process.compute.function.sigmoid.SigmoidD3
import com.wsr.network.process.compute.function.softmax.SoftmaxD1
import com.wsr.network.process.compute.function.softmax.SoftmaxD2
import com.wsr.network.process.compute.function.softmax.SoftmaxD3
...
import com.wsr.network.process.compute.norm.layer.d3.LayerNormD3
...
import com.wsr.network.process.compute.position.PositionEncodeD2
import com.wsr.network.process.compute.position.RoPED2
import com.wsr.network.process.compute.scale.d1.ScaleD1
import com.wsr.network.process.compute.scale.d2.ScaleAxisD2
import com.wsr.network.process.compute.scale.d2.ScaleD2
import com.wsr.network.process.compute.scale.d3.ScaleAxisD3
import com.wsr.network.process.compute.scale.d3.ScaleD3
import com.wsr.network.process.compute.skip.SkipD1
import com.wsr.network.process.compute.skip.SkipD2
import com.wsr.network.process.compute.skip.SkipD3
import com.wsr.network.process.reshape.gad.GlobalAverageD2ToD1
import com.wsr.network.process.reshape.gad.GlobalAverageD3ToD1
import com.wsr.network.process.reshape.gad.GlobalAverageD3ToD2
import com.wsr.network.process.reshape.reshape.ReshapeD2ToD1
...
private val buildInSerializersModule = SerializersModule {
    polymorphic(Process::class) {
        ...
        // Function
        subclass(com.wsr.network.process.compute.function.linear.LinearD1::class)
        subclass(com.wsr.network.process.compute.function.linear.LinearD2::class)
        subclass(com.wsr.network.process.compute.function.linear.LinearD3::class)
