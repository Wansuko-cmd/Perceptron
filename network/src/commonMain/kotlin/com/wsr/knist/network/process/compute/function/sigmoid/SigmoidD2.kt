...
@Serializable
class SigmoidD2 internal constructor(override val outputI: Int, override val outputJ: Int) : Compute.D2() {
...
fun <T> NetworkBuilder.D2<T>.sigmoid() = addProcess(SigmoidD2(outputI = inputX, outputJ = inputY))
