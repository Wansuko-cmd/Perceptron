...
@Serializable
internal class ReshapeD1ToD3(override val outputX: Int, override val outputY: Int, override val outputZ: Int) :
    Reshape.D1ToD3() {
    override fun expect(input: Batch<IOType.D1>, context: Context): Batch<IOType.D3> =
