...
sealed interface Reshape : Process {
    ...
    abstract class D1ToD3 : Reshape {
        ...
        protected abstract fun expect(input: Batch<IOType.D1>, context: Context): Batch<IOType.D3>
    ...
    abstract class D2ToD3 : Reshape {
        ...
        protected abstract fun expect(input: Batch<IOType.D2>, context: Context): Batch<IOType.D3>
