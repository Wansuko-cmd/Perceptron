...
class SoftmaxWithLossD2Test {
    ...
    fun `expect=softmaxを計算`() = networkTestRule {
        ...
        assertEquals(expected = 0.2689f, actual = actual[0][0][0].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = 0.7310f, actual = actual[0][0][1].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = 0.2689f, actual = actual[0][1][0].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = 0.7310f, actual = actual[0][1][1].get(), absoluteTolerance = 1e-4f)
    }
    ...
    fun `train=softmaxの逆伝播`() = networkTestRule {
        ...
        assertEquals(expected = 0.2689f, actual = delta[0][0][0].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = -1.2689f, actual = delta[0][0][1].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = -3.7310f, actual = delta[0][1][0].get(), absoluteTolerance = 1e-4f)
        assertEquals(expected = -5.2689f, actual = delta[0][1][1].get(), absoluteTolerance = 1e-4f)
    }
}
